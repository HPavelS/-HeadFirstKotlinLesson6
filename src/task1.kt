...
fun main(args: Array<String>) {
    ...
    println("${m2 == m3}. My opinion is true")
    println("${s1 == s3}. My opinion is false")
    var m4 = m1.copy()
    println("${m1 == m4}. My opinion is true")
    var m5 = m1.copy()
    println("${m1 === m5}. My opinion is false")
    var m6 = m2
    m2 = m3
    println("${m3 == m6}. My opinion is true")
}